...
public class UDPFileReceiver
{
    ...
    public UDPFileReceiver(DatagramSocket socket, String sourecFile) throws IOException
    {
    	this.sourceFile = sourecFile;
        this.socket = socket;
        ...
        File foldergoc = new File("DataInput/" + this.sourceFile);
        System.out.println("*** check file "+this.sourceFile+" ***");
        if(!foldergoc.exists()){
        	foldergoc.mkdir();
        	System.out.println("*** createfile "+this.sourceFile+" ***");
        }
        fileWriter = new FileOutputStream("DataInput/" + this.sourceFile + "/"+filename);
